...
class Sender(SenderBase):
    ...
    def _prepare_kv_blocks_for_transfer(
        ...
        *,
        ...
        if block_diff == 1:
            # Speculative decoding may reserve one destination block for draft
            # tokens that are absent from the context-side source list.
            logger.debug(
                "Trimming 1 extra dst block for draft tokens: "
